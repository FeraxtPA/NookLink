...
public:
    ...
    void SetFocusTarget(Vector2 target, float zoom, bool immediate = false);
    void ClearFocusTarget();
    bool HasFocusTarget() const { return m_HasFocusTarget; }
...
private:
    ...
    Vector2 m_FocusTarget{ 0.0f, 0.0f };
    float m_FocusZoom = 0.5f;
    float m_FocusTargetLerpSpeed = 7.0f;
    float m_FocusZoomLerpSpeed = 6.0f;
};
